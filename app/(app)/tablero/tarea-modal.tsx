...
const REPETIR_ITEMS = Object.fromEntries(
            ...
            {showAdjForm && (
              <form onSubmit={handleAddAdjunto} className="flex flex-col gap-2">
                <input
                  ...
                  className="border-input bg-background focus:ring-ring h-8 rounded-md border px-3 text-sm outline-none focus:ring-1"
                  required
                />
                <input
                  value={nuevoAdjUrl}
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <Button type="submit" size="sm" disabled={isPendingAdj}>
                    Agregar
                  </Button>
                </div>
              </form>
                ...
                {comentarios.map((c) => (
                  <div key={c.id} className="group flex gap-2.5">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-foreground/90 mt-0.5 text-sm leading-snug whitespace-pre-wrap">
                        {c.contenido}
                      </p>
                    </div>
                  </div>
                  ...
                  {log.map((entry) => (
                    ...
                    >
                      <span className="shrink-0">
                        {formatRelativo(entry.creado_en)}
                      </span>
                      <span className="text-foreground/70 shrink-0 font-medium">
                        {entry.autor_nombre ?? "Sistema"}
                      </span>
                      <span>
                        cambió{" "}
