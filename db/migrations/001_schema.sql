...
-- === usuario =================================================================
-- Sin FK a auth.users (no usamos Supabase Auth). Las credenciales se manejan
-- con password_hash (bcrypt). El registro crea el usuario con estado 'pendiente';
-- un administrador lo activa manualmente.
